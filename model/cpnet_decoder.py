...
class upsample(nn.Module):
    def __init__(self, nbase, sz, residual_on=True, concatenation=False):
        super().__init__()
        self.upsampling0 = nn.Upsample(scale_factor=4, mode='nearest')
...
if __name__ == "__main__":
    ...
    model = CPnet3DDecoder(nbase=[1, 32, 64, 128, 256], out_classes=3, sz=3, residual_on=False, style_on=False, concatenation=True)
