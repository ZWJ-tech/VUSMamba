...
if __name__ == "__main__":
    ...
    model = CPnet3D(nbase=[1, 32, 64, 128, 256], out_classes=3, sz=3, residual_on=False, style_on=False, concatenation=True)
